...
%---------------------------------------------
SNR = 70;
noisy_signal_SNR70 = sequence_make_noise(SNR,number_of_sample,SAW);
SNR = 60;
noisy_signal_SNR60 = sequence_make_noise(SNR,number_of_sample,SAW);
SNR = 50;
noisy_signal_SNR50 = sequence_make_noise(SNR,number_of_sample,SAW);
SNR = 40;
noisy_signal_SNR40 = sequence_make_noise(SNR,number_of_sample,SAW);
SNR = 30;
noisy_signal_SNR30 = sequence_make_noise(SNR,number_of_sample,SAW);
SNR = 20;
noisy_signal_SNR20 = sequence_make_noise(SNR,number_of_sample,SAW);
SNR = 10;
noisy_signal_SNR10 = sequence_make_noise(SNR,number_of_sample,SAW);
